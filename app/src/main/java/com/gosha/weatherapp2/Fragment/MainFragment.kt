package com.gosha.weatherapp2.Fragment
...
import com.gosha.weatherapp2.DialogManager
import com.gosha.weatherapp2.MainViewModel
import com.gosha.weatherapp2.R
import com.gosha.weatherapp2.adapters.VpAdapter
import com.gosha.weatherapp2.adapters.WeatherModel
import com.gosha.weatherapp2.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    private fun updateCurrentCard() = with(binding){
        model.lifeDataCurrent.observe(viewLifecycleOwner){
            ...
            tvData.text = it.time
            tvCity.text = it.city
            tvCurrentTemp.text = if (it.currentTemp.isNotEmpty()) "${it.currentTemp}℃" else maxMinTemp
    ...
    private fun permissionListener(){
        pLauncher = registerForActivityResult(ActivityResultContracts.RequestPermission()){
            Toast.makeText(activity, "Pemission is $it", Toast.LENGTH_LONG).show()
        }
    }
